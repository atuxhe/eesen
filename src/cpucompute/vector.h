...
#ifndef CPUCOMPUTE_VECTOR_H_
#define CPUCOMPUTE_VECTOR_H_ 1
...
class VectorBase {
 public:
  ...
  /// Copy from CuVector.  This is defined in ../gpucompute/cuda-vector.h
  template<typename OtherReal>
  ...
  /// The following is implemented in ../gpucompute/cuda-matrix.cc
...
class Vector: public VectorBase<Real> {
 public:
  ...
  /// This is defined in ../gpucompute/cuda-vector.h
  template<typename OtherReal>
